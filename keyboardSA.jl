...
smartTraditionalLayoutMap = Dict{Int,Tuple{Float64,Float64,Int,Int,Int}}(
    ...
    11 => (10.5, 4.5, 1, 8, 0),
    2 => (11.5, 4.5, 1, 8, 0),
    1 => (12.5, 4.5, 1, 8, 0), 12 => (2, 3.5, 2, 1, 0),
    26 => (3, 3.5, 2, 2, 0),
    32 => (4, 3.5, 2, 3, 0),
    38 => (5, 3.5, 2, 4, 0),
    39 => (6, 3.5, 2, 4, 0),
    ...
    27 => (12, 3.5, 2, 8, 0),
    4 => (13, 3.5, 2, 8, 0),
    3 => (14, 3.5, 2, 8, 0), 36 => (2.25, 2.5, 3, 1, 1),
    42 => (3.25, 2.5, 3, 2, 1),
    44 => (4.25, 2.5, 3, 3, 1),
    45 => (5.25, 2.5, 3, 4, 1),
    34 => (6.25, 2.5, 3, 4, 0),
    ...
    43 => (10.25, 2.5, 3, 7, 1),
    37 => (11.25, 2.5, 3, 8, 1),
    23 => (12.25, 2.5, 3, 8, 0), 15 => (2.75, 1.5, 4, 1, 0),
    17 => (3.75, 1.5, 4, 2, 0),
    28 => (4.75, 1.5, 4, 3, 0),
    29 => (5.75, 1.5, 4, 4, 0),
    13 => (6.75, 1.5, 4, 4, 0),
...
linearLayoutMap = Dict{Int,Tuple{Float64,Float64,Int,Int,Int}}(
    ...
    11 => (10.5, 4.5, 1, 7, 0),
    12 => (11.5, 4.5, 1, 8, 0),
    13 => (12.5, 4.5, 1, 8, 0), 14 => (2.5, 3.5, 2, 1, 0),
    15 => (3.5, 3.5, 2, 2, 0),
    16 => (4.5, 3.5, 2, 3, 0),
    17 => (5.5, 3.5, 2, 4, 0),
    18 => (6.5, 3.5, 2, 4, 0),
    ...
    23 => (11.5, 3.5, 2, 8, 0),
    24 => (12.5, 3.5, 2, 8, 0),
    25 => (13.5, 3.5, 2, 8, 0), 26 => (2.5, 2.5, 3, 1, 1),
    27 => (3.5, 2.5, 3, 2, 1),
    28 => (4.5, 2.5, 3, 3, 1),
    29 => (5.5, 2.5, 3, 4, 1),
    30 => (6.5, 2.5, 3, 4, 0),
    ...
    34 => (10.5, 2.5, 3, 7, 1),
    35 => (11.5, 2.5, 3, 8, 1),
    36 => (12.5, 2.5, 3, 8, 0), 37 => (2.5, 1.5, 4, 1, 0),
    38 => (3.5, 1.5, 4, 2, 0),
    39 => (4.5, 1.5, 4, 3, 0),
    40 => (5.5, 1.5, 4, 4, 0),
    41 => (6.5, 1.5, 4, 4, 0),
...
function appendUpdates(updateLine)
    file = open("results/iterationScores.txt", "a")
...
function runSA(
    ...
    appendUpdates("\nStarting new Run")
    appendUpdates("temperature | iteration | bestObjective | newObjective")
